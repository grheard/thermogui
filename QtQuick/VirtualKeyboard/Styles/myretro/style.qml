...
KeyboardStyle {
    ...
    readonly property string resourcePath: "QtQuick/VirtualKeyboard/Styles/myretro/"
    readonly property string resourcePrefix: "file:" + resourcePath
    ...
    backspaceKeyPanel: KeyPanel {
        ...
        Image {
            ...
            smooth: false
            source: resourcePrefix + "images/backspace-white.svg"
        }
        states: [
            State {
                name: "pressed"
    ...
    enterKeyPanel: KeyPanel {
        ...
        Image {
            ...
            source: {
                ...
                default:
                    return resourcePrefix + "images/enter-white.svg"
                }
            }
        }
        Text {
    ...
    hideKeyPanel: KeyPanel {
        ...
        Image {
            ...
            smooth: false
            source: resourcePrefix + "images/hidekeyboard-white.svg"
        }
        states: [
            State {
                name: "pressed"
    ...
    shiftKeyPanel: KeyPanel {
        ...
        Image {
            ...
            smooth: false
            source: resourcePrefix + "images/shift-white.svg"
        }
        states: [
            State {
                name: "pressed"
